...
describe('Test pool functionality', () => {
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'immature': 10000, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'generate': 0, 'immature': 20000 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    const expected = {
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'immature': 5000, 'generate': 0 },
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn': { 'immature': 5000, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'immature': 8474.10994411, 'generate': 0 },
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn': { 'immature': 1525.89005589, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'generate': 10000, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'immature': 0, 'generate': 20000 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [9]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'immature': 0, 'generate': -10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'immature': 9570.00569668, 'generate': 0 },
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn': { 'immature': 429.99430332, 'generate': 0 }};
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
