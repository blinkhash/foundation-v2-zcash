...
function mockSetupPrimaryBlockchain(pool, callback) {
  nock('http://127.0.0.1:8232')
    .post('/').reply(200, JSON.stringify([
      { id: 'nocktest', error: null, result: testdata.getBlockTemplate() },
      { id: 'nocktest', error: null, result: testdata.getBlockSubsidy() },
    ]));
...
function mockClient() {
  ...
  client.id = 'test';
  client.addrPrimary = 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym';
...
describe('Test pool functionality', () => {
  ...
  let blockchainDataCopy, peerDataCopy, subsidyCopy, transactionDataCopy;
  beforeEach(() => {
  ...
  test('Test pool settings setup [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.setupSettings(() => {
        expect(configCopy.primary.address).toBe('t3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym');
  ...
  test('Test pool settings setup [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:8232')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: true, result: { isvalid: true, address: 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool settings setup [4]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:8232')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: null, result: { isvalid: false, address: 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool manager setup [8]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Submitted a primary block (Zcash:1) successfully to Zcash\'s daemon instance(s)');
        ...
        mockSetupPrimaryBlockchain(pool, () => {
          mockSetupAuxiliaryBlockchain(pool, () => {
            ...
            pool.setupFirstJob(() => {
              ...
              expect(pool.manager.currentJob.rpcData.height).toBe(1911389);
              done();
            });
          });
        });
  ...
  test('Test pool block polling setup [1]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[1][1]).toBe('Requested template from primary chain (Zcash:1911390) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool stratum setup [6]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
        expect(response[1][0]).toBe('log');
        expect(response[1][1]).toBe('Difficulty update queued for worker: t3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym (8)');
        pool.network.stopNetwork();
      }
    });
    pool.on('client.socket.success', () => {
  ...
  test('Test pool stratum setup [7]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
        expect(response[1][0]).toBe('log');
        expect(response[1][1]).toBe('Difficulty updated successfully for worker: t3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym (8)');
        pool.network.stopNetwork();
      }
    });
    pool.on('client.socket.success', () => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:8232')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: true, address: 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym' }
        }));
      pool.checkWorker(pool.primary.daemon, 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym', (valid) => {
  ...
  test('Test pool stratum authentication [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkWorker(pool.primary.daemon, 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym.worker1', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkPrimaryWorker('0.0.0.0', 3001, 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:8232')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: false, address: 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym' }
        }));
      pool.checkPrimaryWorker('0.0.0.0', 3001, 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym', () => {}, (result) => {
  ...
  test('Test pool stratum authentication [6]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [7]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym', () => {}, (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': false, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool stratum authentication [10]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym', null, 'test', (result) => {
  ...
  test('Test pool stratum authentication [11]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym', 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym', 'test', (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': true, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const blocks1 = {
      ...
      miner: 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym',
      worker: 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym.worker1',
      category: 'immature',
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym',
      worker: 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym.worker4',
      identifier: 'master',
      invalid: 0,
      round: '15c8343c-9751-4c67-aafa-29ff296da484',
      solo: false,
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_primary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_primary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    worker2.miner = 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn';
    worker2.worker = 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn.worker4';
    const expected = {
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_primary': { 'immature': 4999.998, 'generate': 0 },
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn_false_primary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_primary': { 'immature': 8474.10655446, 'generate': 0 },
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn_false_primary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_primary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_primary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [10]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_auxiliary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [11]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_auxiliary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.worker = 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn.worker4';
    const expected = {
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_auxiliary': { 'immature': 4999.998, 'generate': 0 },
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn_false_auxiliary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [13]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_auxiliary': { 'immature': 8474.10655446, 'generate': 0 },
      't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXyn_false_auxiliary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_auxiliary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [15]', () => {
    ...
    const expected = { 't3XyYW8yBFRuMnfvm5KLGFbEVz25kckZXym_false_auxiliary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handleAuxiliaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
